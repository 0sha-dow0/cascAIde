...
_SYSTEM_CONTENT: Final[str] = (
    ...
    f"- Replace ALL {TARGET_PACKAGE} usage with {REPLACEMENT_PACKAGE}. The rewritten "
    f"file MUST NOT contain the substring '{TARGET_PACKAGE}' anywhere: remove every "
    f"import/require of {TARGET_PACKAGE}, every {TARGET_PACKAGE}.* call, and any "
    f"{TARGET_PACKAGE}-specific helper (e.g. isAxiosError, AxiosError) — reimplement "
    f"their behaviour with {REPLACEMENT_PACKAGE} semantics.\n"
